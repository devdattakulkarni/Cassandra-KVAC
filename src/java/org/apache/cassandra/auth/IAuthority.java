...
public interface IAuthority
{
    ...
    /**
     * This interface is used for K-VAC
     * @param key -- The key of the row that is being accessed
     * @param user -- Authenticated user
     * @param resources -- List of resources
     * @param server -- Handle to the CassandraServer
     * @return
     */ 
    public EnumSet<Permission> authorize(ByteBuffer key, AuthenticatedUser user, List<Object>resources, CassandraServer server);
